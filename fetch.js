...
const getUsers = async function () { 
    ...
    try{
        ...
        //je fait une condition pour etre sur que sa marche car ma méthode fetch ne me dit pas si il y'a une erreur
        if(response.ok) {
            //une fois qu'on a la response on fait un
...
//ici je lance un appel a getUsers pour m'envoyer les utilisateur
getUsers()
...
const insertPost = async function (data) {//parametre data
    ...
    // et notre méthode
    {
        ...
        headers: {//comment je vais lui divulguer les données et saura comment les données sont envoyer
            'Content-Type' : 'application/json'
        },
        body: JSON.stringify(data)//pour les envoyer sous forme de caractère
    })
    //ici j'ai récupérer ce que j'ai envoyer
